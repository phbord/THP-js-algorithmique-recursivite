...
const computeSquareRootRec = (n, p) => {     if (!p) {         p = n / 2.0;     }     var div = n / p;     var res = (div + p) / 2.0;     if (p == res) {         return p     }     return computeSquareRootRec(n, res); };  console.log(computeSquareRootRec(144));
const computeSquareRoot = (n) => {
    let init = n;
    let res = Number.isInteger(n) && init !== n ? 1 : n / computeSquareRoot(--n);
    console.log('>>>',res);
    return res;
};
